...
description: "Create single or batch text embeddings using Ollama's native /api/embed endpoint, with optional dimension control and provider-specific options like truncate and keep_alive."
---
