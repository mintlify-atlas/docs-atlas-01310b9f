...
description: "Generate text from any Ollama-installed model using Chat Completions or the Responses API, with vision, tool calling, reasoning, and structured output."
---
