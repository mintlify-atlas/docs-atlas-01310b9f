...
description: "OllamaImageModel posts to Ollama's experimental /images/generations endpoint and restricts the request to only the four fields Ollama currently accepts."
---
