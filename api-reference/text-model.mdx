...
description: "OllamaTextModel generates and streams text via Chat Completions or the Responses API, with vision, tool calling, reasoning, and structured output support."
---
