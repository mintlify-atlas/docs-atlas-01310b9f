---
title: "OllamaEmbeddingModel: Native Embeddings Reference"
sidebarTitle: "OllamaEmbeddingModel"
description: "OllamaEmbeddingModel sends embedding requests to Ollama's native /api/embed endpoint, supporting batch inputs, dimension control, and provider-specific options."
---
